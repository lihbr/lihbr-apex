...
const createStarryNight = async () => {
	...
	const [
		...
		import("@wooorm/starry-night/lang/source.tsx.js"),
		import("@wooorm/starry-night/lang/text.html.vue.js"),
	]);

	STARRY_NIGHT = await createStarryNight([...common, sourceTSX, sourceVue]);
